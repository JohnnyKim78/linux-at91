...
#include "wilc_oswrapper/include/wilc_oswrapper.h"
#include "itypes.h"
...
static int Handle_RemainOnChan(void* drvHandler,tstrHostIfRemainOnChan* pstrHostIfRemainOnChan)
{
	...
	/*prepare configuration packet*/
	strWIDList[0].u16WIDid = (WILC_Uint16)WID_CURRENT_CHANNEL;
	strWIDList[0].enuWIDtype= WID_CHAR;
	strWIDList[0].ps8WidVal = (WILC_Sint8*)&(pstrHostIfRemainOnChan->u16Channel);
	strWIDList[0].s32ValueSize = sizeof(WILC_Char);
	
	u8remain_on_chan_flag = WILC_TRUE;

	strWIDList[1].u16WIDid	= (WILC_Uint16)WID_REMAIN_ON_CHAN;
	strWIDList[1].enuWIDtype	= WID_CHAR;
	strWIDList[1].ps8WidVal = (WILC_Sint8*)&u8remain_on_chan_flag;
	strWIDList[1].s32ValueSize = sizeof(WILC_Char);
	/*WILC_Uint8 reset=1;
	PRINT_D(GENERIC_DBG,"WID RESET \n");
	strWIDList[1].u16WIDid	= (WILC_Uint16)WID_RESET;
	strWIDList[1].ps8WidVal = (WILC_Sint8*)&reset;
	strWIDList[1].enuWIDtype	= WID_CHAR;
	strWIDList[1].s32ValueSize = sizeof(WILC_Char);*/
...
tstrWILC_WFIDrv * pstrWFIDrv = (tstrWILC_WFIDrv *) drvHandler;
	...
	strWID.enuWIDtype	= WID_CHAR;
	strWID.ps8WidVal = (WILC_Sint8*)&u8remain_on_chan_flag;
	strWID.s32ValueSize = sizeof(WILC_Char);
	...
	/*Restoring state after remain on channel is expired*/
...
*  @version		1.0
*/
WILC_Sint32 host_int_remain_on_channel(WILC_WFIDrvHandle hWFIDrv, WILC_Uint32 u32duration, WILC_Uint16 chan,tWILCpfRemainOnChanExpired RemainOnChanExpired, tWILCpfRemainOnChanReady RemainOnChanReady,void* pvUserArg)
{
	WILC_Sint32 s32Error = WILC_SUCCESS;
	tstrWILC_WFIDrv * pstrWFIDrv = (tstrWILC_WFIDrv *)hWFIDrv;
	tstrHostIFmsg strHostIFmsg;
...
*  @version		1.0
*/
WILC_Sint32 host_int_ListenStateExpired(WILC_WFIDrvHandle hWFIDrv)
{
	WILC_Sint32 s32Error = WILC_SUCCESS;
	tstrWILC_WFIDrv * pstrWFIDrv = (tstrWILC_WFIDrv *)hWFIDrv;
	tstrHostIFmsg strHostIFmsg;
...
#if (defined WILC_SDIO) && (!defined USE_DMA_VER_1) && (!defined WILC_SDIO_IRQ_GPIO)
...
WILC_Sint32 host_int_delBASession(WILC_WFIDrvHandle hWFIDrv, char* pBSSID,char TID,void * drvHandler)
{
	WILC_Sint32 s32Error = WILC_SUCCESS;
	tstrWILC_WFIDrv * pstrWFIDrv = (tstrWILC_WFIDrv *)hWFIDrv;
	tstrHostIFmsg strHostIFmsg;
