...
#define _WILC_INT_STATS_PRE_D0	    0x1488
#define _WILC_INT_STATS_D0_AND_LATER	0x149c
...
#define _WILC_GP_REG_1_PRE_D0         0x148c
#define _WILC_GP_REG_1_D0_AND_LATER   0x14a0

#define WILC_HAVE_SDIO_IRQ_GPIO (1 << 0)
#define WILC_HAVE_RTC           (1 << 1)
#define WILC_HAVE_DMA_VER_2     (1 << 2)
#define WILC_HAVE_VCO_14_SUPPLY (1 << 3)
#define WILC_XTAL_24 (1 << 4)
#define WILC_DISABLE_NMC_UART (1 << 5)
